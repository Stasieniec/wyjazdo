...
export const metadata: Metadata = {
  title: "Umowa powierzenia przetwarzania danych — wyjazdo.pl",
};

export default async function DpaPage() {
  const doc = await getLatestDocument("dpa");

  if (!doc) {
    return (
      <div>
        <h1 className="text-2xl font-bold">Umowa powierzenia przetwarzania danych osobowych</h1>
