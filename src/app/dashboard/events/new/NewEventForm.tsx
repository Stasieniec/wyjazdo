...
export function NewEventForm({ subdomain }: { subdomain: string }) {
  ...
  return (
    <div>
      <p className="text-xs font-semibold uppercase tracking-wide text-primary">
        Krok 1 z 2: Podstawowe informacje
      </p>
        ...
        <form action={formAction} className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-1.5 rounded-lg bg-muted/60 px-3 py-1.5 font-mono text-xs text-muted-foreground">
              {subdomain}.{rootDomain}/<strong className="text-foreground">{slugPreview || "..."}</strong>
            </p>
          </div>
          ...
          <div className="space-y-1.5">
            <p className="text-sm font-semibold text-foreground">Galeria zdjęć</p>
            <p className="text-sm text-muted-foreground">
              Dodaj do 5 zdjęć prezentujących wydarzenie — np. miejsce, poprzednie edycje, atrakcje.
            </p>
