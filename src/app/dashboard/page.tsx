      ...
      {events.length === 0 ? (
        <>
          <div className="mt-8 rounded-lg border border-border bg-muted/50 p-4 text-sm text-muted-foreground">
            <p>
              <strong className="font-medium text-foreground">Zaczniesz od szkicu.</strong>{" "}
              Nowe wydarzenie najpierw zapisujesz jako szkic (widzisz je tylko Ty). Uzupełnij
              szczegóły, dodaj pytania do uczestników i opublikuj, gdy będzie gotowe.
            </p>
          </div>
